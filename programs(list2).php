...
$outer_table = 'departments';                     // name of outer (parent) table
$inner_table = 'pg';                     // name of inner (child) table
$screen      = 'programs.list2.screen.inc';    // file identifying screen structure
